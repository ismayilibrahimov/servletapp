                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="all-form-element-inner">
                                        ...
                                        <form action="${pageContext.request.contextPath}/dashboard/edit/${post.getId()}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-select-list">
                                                            <select class="form-control custom-select-value" name="category">
                                                                <c:forEach items="${categories}" var="category">
                                                                    ...
                                                                    <option value="${category.getId()}"  ${(catId eq postCatId)?'selected':''} >${category.getName()}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <textarea class="form-control" name="content" id="summernote1" rows="5">${post.getContent()}</textarea>
                                                    </div>
                                                </div>
                                            </div>
